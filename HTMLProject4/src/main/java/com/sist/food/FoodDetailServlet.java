...
public class FoodDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			out.println("<td>");
			out.println("<img src="+st.nextToken()+" style=\"width:100%\">"); // width:100% -> 높이 자동
		...
		out.println("</div>");
		out.println("<div class=row>");
		// lg , sm , md , xs => 해상도에 따라 다르게 설정	 // 브라우저의 전체 화면은 12이므로, 8:4로 화면 분할
		// 8:4로 나눠서 상세보기 / 지도 출력위치 구분
		...
		out.println("</tr>");
		out.println("</table>");
		out.println("<div style=\"height:20px;\"></div>");	// 공백을 줄 때, p태그 말고, div height 쓰기
		out.println("<table class=table>");
		out.println("<tr>");
