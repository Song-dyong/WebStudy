...
public class MainServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		// 사용자가 보내준 값을 mode라는 String에 저장하기
		...
		out.write("</head>");
		out.write("<body>");
		out.write("<nav class=\"navbar navbar-inverse navbar-fixed-top\">"); // fixed --> 메뉴바 고정
		...
		out.write(
				"      <li class=\"dropdown\"><a class=\"dropdown-toggle\" data-toggle=\"dropdown\" href=\"#\">사용자<span class=\"caret\"></span></a>");
