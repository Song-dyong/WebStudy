...
JSP코딩영역
		...
		<tr>
			<td colspan=2>
				<ul>
					...
					<li>JSP파일에서 서블릿 관련된 객체</li>
					<li>JSP파일에서 예외와 관련된 객체</li>
				</ul>
			</td>
		</tr>
		<tr>
			<td width=25%>request</td>
			<td width=75%>사용자 관련(요청정보, 브라우저정보, 추가정보)</td>
		</tr>
		<tr>
			<td width=25%>response</td>
			<td width=75%>서버응답정보, 화면이동정보, 헤더정보</td>
		</tr>
		<tr>
			<td width=25%>out</td>
			<td width=75%>출력 버퍼와 관련, 화면출력정보
			<br><sub>출력버퍼: 실행된 HTML을 저장하는 공간 (브라우저가 읽어가는 공간)</sub>
			</td>
		</tr>
		<tr>	
		...
		<tr>
			...
			<td width=75%>페이지의 흐름 관리(request): JSP 여러개 조립</td>
		</tr>
		<tr>
