		...
		<tr>
			...
			<td width=80%>
				<ul>
					...
					자원 정보
						<ul>
							<li><sup style="color:gold">★</sup>getInitParameter()<sup style="color:gold">★</sup>: web.xml에 등록된 데이터</li>
							<li><sup style="color:gold">★</sup>getRealPath()<sup style="color:gold">★</sup>: 톰캣이 읽어가는 실제 경로</li>
						</ul>
					</li>
				</ul>
			</td>
