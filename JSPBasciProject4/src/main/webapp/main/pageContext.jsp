		...
		<tr>
			...
			<td width=80%>
				<ul>
					...
					페이지 연결
						<ul>
							<li><sup style="color:gold">★</sup>include()<sup style="color:gold">★</sup>: 여러 개의 JSP를 조립 => &lt;jsp:include&gt; (사이트제작)</li>
							<li><sup style="color:gold">★</sup>forward()<sup style="color:gold">★</sup>: HTML만 덮어쓰는 역할 => &lt;jsp:forward&gt; (MVC 주로 사용)</li>
						</ul>
					</li>
					<li>
					내부객체 정보 얻기
