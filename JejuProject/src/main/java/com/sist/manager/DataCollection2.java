			...
			for (ActivityCategoryVO vo : list) {
				...
				for (int i = 0; i < linkCount; i++) {
					...
					WebElement posterLink = findElementWithFallback(driver, By.xpath(
							"/html/body/div[4]/div/div/div/div[2]/main/div/div[2]/a[" + gg + "]/div/div/img"));
					...
					List<WebElement> images2 = driver.findElements(By
							.xpath("/html/body/main/div[3]/div/div[2]/div/article/section[2]/div/div/div/div[1]/img"));
					...
					// 평점 태그
					WebElement score = findElementWithFallback(driver,
							By.xpath("/html/body/main/div[3]/div/div[2]/div/article/header/div[2]/div/button/span[1]"));
					avo.setScore(score != null ? Double.parseDouble(score.getText()) : 0.0);
					// 리뷰 갯수
					WebElement review_count = findElementWithFallback(driver,
							By.xpath("/html/body/main/div[3]/div/div[2]/div/article/header/div[2]/div/button/span[2]"));
					...
					avo.setPrice(
							price != null ? Integer.parseInt(price.getText().replace(",", "").replaceAll("원", "")) : 0);

					WebElement reviewer = findElementWithFallback(driver,
							By.xpath("/html/body/main/div[3]/div/div[2]/div/article/section[3]/div/div/div/div[2]/p"));
					...
					if (hours_use == null) {
						hours_use = findElementWithFallback(driver,
								By.xpath("/html/body/main/div[3]/div/div[2]/div/article/section[5]/div/div/div[1]/p"));
						if (hours_use == null) {
