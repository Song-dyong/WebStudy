...
$(function(){
	$.ajax({
		...
		// result => food_list.do를 통해 만들어진 페이지 소스보기의 내용 
						...
						<table class="table">
							...
							<tr>
								<td colspan="2" class="text-center">
									<img alt="" src="default.png" style="width:200px;height: 220px;" id="food_img">
								</td>
							</tr>
							<tr>
								<td colspan="2">
							...
							<%--
								no: 자동증가 / id => session에 저장된 상태
								fno, rday, rtime, inwon 를 저장해서 보내야 예약 가능
							 --%>
