...
<body>
	<h2 class="sectiontitle">${sessionScope.name }님의 장바구니목록</h2>
	<table class="table">
		<tr>
		...
		<c:forEach var="vo" items="${list }">
			<tr>
				...
				<td class="text-center"><img src="${vo.goods_poster }"
				...
				<td class="text-center" id="total_price">${vo.amount*vo.price }</td>
				<td class="text-center">
				<input type="button" class="btn btn-sm btn-success" id="byBtn" value="구매" data-no="${vo.cart_no }">
