					...
					<table class="table">
						...
						<tr>
							...
							<td width=90% class="inline"><input type=text name=post
								id=post size=10 class="input-sm" value="${vo.post }"> <input type=button
						...
						<tr>
							...
							<td width=90% class="inline"><input type=text name=addr1
								id=addr1 size=55 class="input-sm" readonly value="${vo.addr1 }"></td>
						</tr>

						<tr>
							<th class="text-right" width=10%>상세주소</th>
							<td width=90% class="inline"><input type=text name=addr2
								id=addr2 size=55 class="input-sm" value="${vo.addr2 }"></td>
						</tr>
						...
						<tr>
							...
							<td width=90% class="inline"><select name=phone1
								class="input-sm">
									<option>010</option>
							</select> <input type=text name=phone id=phone size=12 class="input-sm" value="${vo.phone }">
						...
						<tr>
							<td colspan="2" class="text-center"><input type="button"
								value="회원수정" class="btn btn-success btn-sm" id="joinBtn">
