...
.app {
	...
	display: flex;
	justify-content: center;
	align-items: center; & __bg { position : absolute;
	width: 100%;
	height: 100%;
	z-index: -5;
	filter: blur(8px);
...
.cardList {
	...
	height: auto; & __btn { --btn-size : 35px;
	width: var(--btn-size);
	height: var(--btn-size);
	position: absolute;
	top: 50%;
...
.card {
	...
	user-select: none; &:: before { content : "";
	position: absolute;
	left: 0;
	top: 0;
	width: 100%;
...
__image {
	position: relative;
	width: 100%;
	height: 100%; img { position : absolute;
	left: 0;
	top: 0;
	width: 100%;
	height: 100%;
...
.infoList {
	...
	width: calc(3 * var(--card-width));
	height: var(--card-height);
	pointer-events: none; . info__wrapper { position : relative;
	width: 100%;
	height: 100%;
	display: flex;
...
.info {
	...
	transition: transform var(--card-transition-duration)
		var(--card-transition-easing); . text { position : relative;
...
.location {
	...
	padding-bottom: 0.8rem; &:: before , & : : after { 
			 content : "";
	position: absolute;
	background: #fff;
	left: 0%;
...
.loading__wrapper {
	...
	align-items: center;
	background: #000;
	z-index: 200; . loader--text { color : #fff;
	font-family: "Montserrat";
	font-weight: 500;
...
.loader {
	...
	width: 200px;
	height: 2px;
	background: rgba(255, 255, 255, 0.25); span { position : absolute;
	left: 0;
	top: 0;
	width: 100%;
	height: 100%;
